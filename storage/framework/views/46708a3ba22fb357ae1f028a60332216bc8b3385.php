                ...
                <div class="col-lg-9">
                    <div class="singlepost">
                        ...
                        <div class="postmeta">
                            <ul>
                                <li>
                                    <a href="<?php echo e(route('blog.category', ['id'=> $blog->postCategory->id, 'slug'=> \Str::slug($blog->postCategory->name, '-')] )); ?>">
                                ...
                                <li> <i class="icon_cursor_alt"></i> <?php echo e($blog->view); ?></li>
                            </ul>
                        </div>
                        <!-- /post meta -->
                        ...
                        <div class="col-md-12 block">
                            <div class="block-header">
                                <div class="title">
                                    ...
                                    <div class="tag"><?php echo e($blog->comments->count()); ?></div>
                                </div>
                    ...
                    <div class="widget">
                        ...
                        <ul class="comments-list">
                            <?php $__currentLoopData = $blognew; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $new): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <div class="alignleft">
                                        <a href="<?php echo e(route('blog.detail', ['id' => $new->id, 'slug' => \Str::slug($new->name, '-')])); ?>">
                                    ...
                                    <small>
                                        ...
                                        </a> - <?php echo e(date('d/m/Y', strtotime($new->created_at))); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        ...
        function load_more_comment(id = '') {
            ...
            $.ajax({
                url: '<?php echo e(route('comment.load_more')); ?>',
                type: 'POST',
                headers: {
        ...
        function load_more_reply(id = '') {
            $.ajax({
                url: '<?php echo e(route('reply.load_more')); ?>',
                type: 'POST',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
        ...
        $('#btn-comment').click(function(ev) {
            ...
            var _token = $('input[name="_token"]').val();
            $.ajax({
                url: '<?php echo e(route('comment.sent', $blog->id)); ?>',
                type: 'POST',
                data: {
                    content: content,
                    _token: _token,
        ...
        $(document).on('click', '#btn-reply', function(ev) {
            ...
            $.ajax({
                url: '<?php echo e(route('reply.sent')); ?>',
                type: 'POST',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
