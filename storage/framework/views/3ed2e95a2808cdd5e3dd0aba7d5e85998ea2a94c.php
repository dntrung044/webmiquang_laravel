                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <input type="email" name="email"
                                                        value="<?php echo e(Auth::user()->email); ?>" class="form-control required"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <input type="number" name="phone"
                                                        value="<?php echo e(Auth::user()->phone); ?>" id="txtphone"
...
<?php echo $__env->make('user.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/trungchodie/Documents/WEB/Laravel/untitled folder/webmiquang_laravel/resources/views/user/reservation/index.blade.php ENDPATH**/ ?>