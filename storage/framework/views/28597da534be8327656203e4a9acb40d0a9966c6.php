                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="mt-6 font-normal text-center text-gray-800 md:mt-0">
                            Đến với Đà Nẵng, Mì Quảng Bà Mua được nhiều du khách rất thích ghé quán để thưởng thức những món
                            ăn nỗi tiếng như mì quảng ếch, mỳ quảng gà, bánh tráng cuốn thịt heo...
                        </p>
                    </div>
                    ...
                    <form class="flex flex-col space-y-5" action="/dang-nhap" method="POST">
                        ...
                        <div class="flex flex-col space-y-1">
                            ...
                            <input name="email" value=" <?php echo e(old('email')); ?>" type="email"
                                style="background: rgb(182, 180, 180);" autofocus placeholder="admin@gmail.com"
                        ...
                        <div class="flex flex-col space-y-1">
                            <div class="flex items-center justify-between">
                                ...
                                <a href="<?php echo e(route('forgotPassword')); ?>"
                                    class="text-sm text-blue-600 hover:underline focus:text-blue-800">Quên mật khẩu?</a>
                            </div>
                            <input name="password" type="password" placeholder="123456"
                                style="background: rgb(182, 180, 180);"
                                class="px-4 py-2 transition duration-300 border border-yellow-400 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-yellow-200" />
                        </div>
...
<?php echo $__env->make('user.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/trungchodie/Documents/WEB/Laravel/untitled folder/webmiquang_laravel/resources/views/user/auth/login.blade.php ENDPATH**/ ?>