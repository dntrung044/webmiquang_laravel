                                                ...
                                                @if ($cou['condition'] == 1)
                                                    ...
                                                    <span>
                                                        @php
                                                            ...
                                                            echo '<span name="coupon">-' .
                                                                number_format($total_coupon, 0, '', '.') .
                                                                'đ</span>';
                                                            $total_coupon_after =
                                                                (int) $total_feeship - (int) $total_coupon;
                                                        @endphp
                                                    </span>
                                                @elseif ($cou['condition'] == 2)
                                                    Mã giảm giá: <span
                                                        name="coupon">-{{ number_format($cou['number'], 0, '', '.') }}đ</span>
                                                    <span>
                                                        @php
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-menu-content">
                                            ...
                                            <div class="radio_select chose_day">
                                                <ul>
                                                    <li>
                                                        <input type="radio" id="day_1" name="day" value="hôm nay"
                                                            required>
                                                        <label for="day_1">Hôm nay</label>
                                                    </li>
                                                    <li>
                                                        <input type="radio" id="day_2" name="day" value="ngày mai"
                                                            required>
                                    ...
                                    <div class="dropdown-menu">
                                        <div class="dropdown-menu-content">
                                            ...
                                            <div class="radio_select add_bottom_15">
                                                <ul>
                                                    <li>
                                                        <input type="radio" id="time_1" name="time" value="10:30">
                                                        <label for="time_1">10:30</label>
                                                    </li>
                                                    <li>
                                                        <input type="radio" id="time_2" name="time" value="11:00">
                                                        <label for="time_2">11:00</label>
                                                    </li>
                                                    <li>
                                                        <input type="radio" id="time_3" name="time" value="11:30">
                                            ...
                                            <div class="radio_select">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <input type="radio" id="time_8" name="time" value="19:30">
                    ...
                    <div class="col-xl-4 mb-5 col-lg-4" id="sidebar_fixed">
                        <div class="box_booking_2 style_2">
                            ...
                            <div class="main">
                                ...
                                <a href="tai-khoan/thay-doi-thong-tin/{{ Auth::user()->id }}"
