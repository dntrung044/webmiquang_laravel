                ...
                <div class="opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.6)">
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            position: relative;
                            padding: 0 16px 0 23px;">
                                        <span>Chi tiết sản phẩm</span></li>
                                </ul>
                            </div>
                        </div>
                        <!-- /row -->
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6">
                            ...
                            <form method="POST" style="margin-bottom: 3px" action="{{ url('/gio-hang/check_coupon') }}">
                                ...
                                <div class="search-box">
                                    ...
                                    <input value="Áp dụng" type="submit" name="check_coupon"
                                    ...
                                    @if (!empty(Session::get('coupon')))
                                        @foreach (Session::get('coupon') as $key => $cou)
                                            ...
                                            @elseif ($cou['condition'] == 2)
                                                ...
                                                <p>-{{ number_format($cou['number'], 0, '', '.') }}đ</p>
                                                <p>
                                                    @php
                    ...
                    <div class="col-md-12">
                        ...
                        width: 30%;">
                                <div class="col-sm-12 empty-cart-cls text-center">
                                    ...
                                    <a href="/thuc-don" class="btn btn-primary cart-btn-transform m-3" data-abc="true">quay
                                        lại chọn món</a>
                                </div>
                            </div>
                        </div>
