                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                @php
                                    $feeship = !empty(Auth::user()->fee) ? Auth::user()->fee : '30000';
                                @endphp
                                ...
                                if (empty(Auth::user()->fee)) {
                                    echo '(
                                        <a href="nguoi-dung/thay-doi-thong-tin/{{ Auth::user()->id)}}" style="color: #f8da45;" >
                                            Thêm vào địa chỉ
                                        ...
                                        @elseif ($cou['condition']==2)
                                            ...
                                            <p>
                                                @php
                                                    ...
                                                    $total_after = (int)$total_coupon + (int)$feeship;
                                                @endphp
                                            </p>
                                            <!-- / <li class="total"> Tổng thanh toán
                            ...
                            <!-- / Tổng-->
                            <li>
                                <span>Tổng giỏ hàng:</span>{{ number_format($total_after, 0, '', '.') }} đ
                            </li>
                        </ul>
