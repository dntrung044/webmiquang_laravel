<ul class="replied-to" id="reply-wrapper">
    ...
    {{-- form reply --}}
    <li>
        <div class="formReplies form-reply-{{ $comment->id }}" style="display: none;">
            {{-- Avatar --}}
            @if ($comment->user->avatar == null)
                <img src="{{ asset('teamplate/img/user.png') }}" class="avatar"alt="img_error">
            @else
                <img src="{{ $comment->user->avatar }}" class="avatar" alt="img_error">
            @endif
            <div class="comment_right clearfix" style="width: 85%;">
                ...
                <div class="form-group">
                    ...
                    <button type="button" class="btn_1b mb-3 ml-2 close-reply-form">Huỷ</button>
                </div>
            </div>
        </div>
    </li>
