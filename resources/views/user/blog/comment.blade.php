                    ...
                    @foreach ($comment->replies as $reply)
                        <li>
                            ...
                            <div class="media-comment-footer">
                                ...
                                <a class="media-footer-option repply btn-show-reply-form" href="#"  data-id="{{ $comment->id }}" style="text-decoration: none;">
                                    <span class="icon-bubble-content">
                                        <svg width="20" height="20" xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1"
                                            viewBox="0 0 24 24">
                        ...
                        <div class="comment_right clearfix" style="width: 85%;">
                            <form method="POST" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control cmt-content-reply-{{ $comment->id }}" rows="3"  placeholder="Nội dung trả lời..."></textarea>
                                </div>
                                <div class="form-group">
                                    <button type="button" data-id="{{ $comment->id }}" class="btn_1 mb-3 btn-reply">Phản hồi</button>
                                </div>
                            </form>
                        </div>
                    </div>
