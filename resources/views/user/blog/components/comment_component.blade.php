                    ...
                    <div class="comment comment_count">
                        ...
                        <div class="comment-content comment_right">
                            <div class="comment-details">
                                ...
                                <span class="comment-log"> {{ $comment->created_at->locale('vi_VN')->diffForHumans() }}
                                </span>
                                            ...
                                            @can('blog-edit')
                                                <li class="li_dropdown">
                                                    <a href="#" data-id="{{ $comment->id }}"
                                                        data-url="{{ route('comment.hidden') }}"
                                                        data-id_blog="{{ $blog->id }}"
                                                        class="a_dropdown button_comment_hidden">Ẩn Bình luận</a>
                                                </li>
                                            @endcan
                                        </ul>
                                    </summary>
                            ...
                            <div class="media-comment-footer">
                                ...
                                <a class="media-footer-option like like-comment" style="text-decoration: none;"
                                    data-id="{{ $comment->id }}" data-url="{{ route('comment.like') }}">
                                    {{-- check user liked --}}
                                ...
                                <a class="media-footer-option repply show-reply-form" href="#"
                                    style="text-decoration: none;" data-id="{{ $comment->id }}"
                                    data-commenter_name="{{ $comment->user->name }}"
                                    data-commenter_id="{{ $comment->user->id }}">
