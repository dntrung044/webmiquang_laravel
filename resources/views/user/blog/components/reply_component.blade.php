                        ...
                        <div class="comment-content comment_right">
                            <div class="comment-details">
                                ...
                                <div class="media-option">
                                    <summary>
                                        <a class="ripple-grow button_ul_dropdown_reply"  data-id="{{ $reply->id }}" href="javascript://" >
                                        ...
                                        <ul class="ul_dropdown form-dropdown-reply_{{ $reply->id }}">
                                            ...
                                            @can('blog-edit')
                                                <li class="li_dropdown">
                                                    <a href="#" data-id="{{ $reply->id }}" data-url="{{ route('reply.hidden') }}" data-id_blog="{{ $blog->id }}" class="a_dropdown button_reply_hidden">Ẩn Bình luận</a>
                                                </li>
                                            @endcan
                                    </ul>
                                    </summary>
                            ...
                            <div class="media-comment-footer">
                                ...
                                <a class="media-footer-option repply reply-form" href="#"
                                    ...
                                    data-reply_name="{{ $reply->user->name }}"  data-reply_id="{{ $reply->user->id }}">
    ...
    <li>
        <div class="comment form-reply">
            ...
            <div class="comment-content comment_right">
                ...
                <div class="form-group">
                    <button type="button" data-id_post="{{ $blog->id }}" data-id="{{ $comment->id }}" data-commenter_id="{{ $comment->id }}"
