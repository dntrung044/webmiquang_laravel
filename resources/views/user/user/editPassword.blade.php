                        ...
                        <form action="" method="POST">
                            ...
                            <div class="main">
                                ...
                                <div class="flex flex-col space-y-1">
                                    ...
                                    <input name="password_old" style="background: none; color: black;" type="password"
                                        placeholder="*******"
                                ...
                                <div class="flex flex-col space-y-1">
                                    ...
                                    <input name="password" style="background: none; color: black;" type="password"
                                        placeholder="*******"
                                        class="px-4 py-2 transition duration-300 border border-yellow-400 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-yellow-200" />
                                ...
                                <div class="flex flex-col space-y-1">
                                    ...
                                    <input name="password_comfirm" style="background: none; color: black;" type="password"
                                        placeholder="*******"
                                        class="px-4 py-2 transition duration-300 border border-yellow-400 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-yellow-200" />
