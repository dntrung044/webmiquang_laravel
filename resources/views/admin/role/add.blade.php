                                ...
                                <tr class="parent">
                                    <td class="fw-bold">
                                        <h6> {{ $permissionItem->name }} ( {{ $permissionItem->description }})
                                            <input class="form-check-input checkbox_role_add" type="checkbox"
                                                value=" {{ $permissionItem->id }}" id="checkAllRoles">
                                        </h6>
                                    </td>
                                </tr>
                            @endforeach
                            <td class="fw-bold">
                                Tất cả các vai trò <input class="form-check-input" type="checkbox"
                                    id="checkbox_add_all">
                            </td>
                        </tbody>
                    </table>
