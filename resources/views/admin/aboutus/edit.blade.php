                ...
                <div class="deadline-form">
                        ...
                        <form action="{{ route('abouts.update', $aboutus->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="email" value="{{ $aboutus->email }} "
                                        class="form-control">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="openH" value="{{ $aboutus->openH }} "
                                        class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Địa chỉ bản đồ</label>
                                    <input type="text" name="map" value="{{ $aboutus->map }}" class="form-control"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"><a
                                href="{{ route('abouts.index') }}">Hủy</a></button>
