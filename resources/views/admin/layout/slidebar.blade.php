    ...
    <ul class="menu-list flex-grow-1 mt-3">
        ...
        <li class="collapsed">
            ...
            <ul class="sub-menu collapse" id="abouts">
                <!-- AboutUs: bài viết-->
                <li><a class="ms-link" href="{{ route('abouts.index') }}">
                        <i class="icofont-ui-note"></i> <span>Bài viết giới thiệu</span>
                    </a></li>
                <!-- AboutUs: hình ảnh-->
                <li><a class="ms-link" href="{{ route('galleries.index') }}">
                        <i class="icofont-image"></i><span>Thư viện hình ảnh</span>
                    </a></li>
                <!-- AboutUs: Slider -->
                <li><a class="ms-link" href="{{ route('sliders.index') }}">
                        <i class="icofont-file-tiff"></i><span>Slider</span>
                    </a></li>
                <!-- AboutUs: Banner -->
                <li><a class="ms-link" href="{{ route('banners.index') }}">
        ...
        <li class="collapsed">
            ...
            <ul class="sub-menu collapse" id="products">
                ...
                <li><a class="ms-link" href="{{ route('product_comments.index') }}"><span>Bình luận món ăn</span></a></li>
            </ul>
        </li>
        ...
        <li class="collapsed">
            ...
            <ul class="sub-menu collapse" id="Blogs">
                ...
                <li><a class="ms-link" href="{{ route('post_categories.index') }}"><span>Danh Mục</span> </a></li>
                <li><a class="ms-link" href="{{ route('post_comments.index') }}"><span>Bình luận</span> </a></li>
            </ul>
        </li>
        ...
        <li class="collapsed">
            ...
            <ul class="sub-menu collapse" id="Transactions">
                <li>
                    <a class="ms-link" href="{{ route('coupons.index') }}">
                        <span>Mã giảm giá</span>
                    </a>
                </li>
                <li>
                    <a class="ms-link" href="{{ route('feeships.index') }}">
                        <span>Phí Vận Chuyển</span>
                    </a>
                </li>
                <li>
                    <a class="ms-link" href="{{ route('transactions.index') }}">Đơn hàng</span> </a>
                </li>
            </ul>
            </a>
        </li>
